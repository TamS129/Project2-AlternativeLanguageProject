...
void FileReader::ReadCSV(string fileName) {
    ...
    while (getline(inputFile, line)) {
        ...
        oem = checkString(temp.c_str());
        temp = "";
        getline(inputString, temp, ',');
        model = checkString(temp.c_str());
        temp = "";
        getline(inputString, temp, ',');
        launch_announced = checkYear(temp.c_str());
        temp = "";
        getline(inputString, temp, ',');
        launch_status = checkStatus(temp.c_str());
        temp = "";
        getline(inputString, temp, ',');
        body_dimensions = checkString(temp.c_str());
        temp = "";
        getline(inputString, temp, ',');
        body_weight = checkWeight(temp.c_str());
        temp = "";
        getline(inputString, temp, ',');
        body_sim = checkSim(temp.c_str());
        temp = "";
        getline(inputString, temp, ',');
        display_type = checkString(temp.c_str());
        temp = "";
        getline(inputString, temp, ',');
        display_size = checkDisplaySize(temp.c_str());
        temp = "";
        getline(inputString, temp, ',');
        display_resolution = checkString(temp.c_str());
        temp = "";
        getline(inputString, temp, ',');
        feature_sensors = checkString(temp.c_str());
        temp = "";
        getline(inputString, temp, ',');
        platform_os = checkPOS(temp.c_str());
        temp = "";
